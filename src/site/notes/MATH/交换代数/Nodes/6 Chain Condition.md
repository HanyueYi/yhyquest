...
- Let $G=(\mathbb{Q}/\mathbb{Z})[p^\infty]=\{x\in \mathbb{Q}/\mathbb{Z}:p^nx=0\mbox{ for some }n\geqslant 1\}$, that is, $G$ is a $\mathbb{Z}$-module generated by $\{1/p,1/p^2,\cdots\}$. It is not a.c.c., but it is d.c.c. In fact, we can prove that all non-trivial submodules are $\mathbb{Z}\cdot\frac{1}{p^n}/\mathbb{Z}$. 
...
**Remark.** 
- Later in theorem 8.5, Artinian ring $\iff$ Noetherian ring with $\dim=0$. Namely, Artinian rings are the most basic Noetherian rings. 
...
**Example.** $0\to \mathbb{Z}/2\mathbb{Z}\to \mathbb{Z}/4\mathbb{Z}\to \mathbb{Z}/2\mathbb{Z}\to 0$, then $\ell(\mathbb{Z}/4\mathbb{Z})=2$. Similarly, we can compute that $\ell_\mathbb{C}(\mathbb{C}[x]/(x^2))=2$ and $\ell_\mathbb{Z}(\mathbb{Z}[x](p^2,x^3))=6$. See [[Pasted image 20250224204354.png]].
